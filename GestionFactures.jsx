...
export default function GestionFactures(props) {
    ...
    useEffect(() => {
        ...
        if (filtrer) {
            req.open('GET', 'http://192.168.1.12/backend-cma/factures_pharmacie.php?filtrer=oui');
            const req2 = new XMLHttpRequest();
            req2.open('GET', 'http://192.168.1.12/backend-cma/factures_pharmacie.php?filtrer=oui&manquant');
            ...
            req.open('GET', 'http://192.168.1.12/backend-cma/factures_pharmacie.php');
        }
    ...
    useEffect(() => {
        if (factureSelectionne.length > 0) {
            ...
            req.open('GET', `http://192.168.1.12/backend-cma/factures_pharmacie.php?id=${factureSelectionne[0].id}`);
    ...
    const mettreAjourData = () => {
     ...
     const reglerFacture = () => {
         if (verse > 0) {
            ...
            const req = new XMLHttpRequest();
            req.open('POST', 'http://192.168.1.12/backend-cma/factures_pharmacie.php')
